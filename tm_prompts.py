...
TEMPLATE_KEY = {
    "7 Emails, 1 Call + LinkedIn": "tm_conversation",
...
DEFAULT_SEQUENCE = "7 Emails, 1 Call + LinkedIn"
...
ROUTINES = [
        ...
        "fields": [
            ...
            F("search_terms", "What to search for", "details",
              default="Manila, Cebu, Philippines, offshore team, offshore "
                      ...
                      "assistant"),
        ] + _newsletter_fields() + _email_fields("7 Emails, 1 Call + LinkedIn") + \
    ...
    },
    {
        ...
        "fields": [
            ...
            "7 Emails, 1 Call + LinkedIn") + _size_fields("5", "4", "120") + \
            SKIP_FIELDS,
        "steps": [
            "{vertical_guide}",
    ...
    },
    {
        ...
        "fields": [
            ...
            "7 Emails, 1 Call + LinkedIn") + _size_fields("8", "4", "160") + \
            SKIP_FIELDS,
        "steps": [
            "{vertical_guide}",
    ...
    },
    {
        ...
        "fields": [
            ...
            "7 Emails, 1 Call + LinkedIn", "the audience name") + [
